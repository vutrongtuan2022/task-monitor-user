...
function TableContracfund({}: PropsTableContracFund) {
	...
	const {data: listContractFundForOverView} = useQuery(
		[QUERY_KEY.table_contract_fund_for_over_view, projectUuid, month, year, page, pageSize],
		{
			queryFn: () =>
				httpRequest({
			...
			<div className={clsx(styles.basic_info, styles.mt)}>
				...
				<WrapperScrollbar>
					<DataWrapper
						...
						loading={listContractFundForOverView?.isLoading}
						...
						<Table
							...
							column={[
								...
								},
								{
									...
									render: (data: IContractFund) => <>{data?.reverseAmount}</>,
								},
								{
									title: 'Vốn dự án (VND)',
