...
import {IReportWorkLastMonth, PropsTableWorkLastMonthCreate} from './interfaces';
import styles from './TableWorkLastMonthCreate.module.scss';
...
function TableWorkLastMonthCreate({}: PropsTableWorkLastMonthCreate) {
...
export default TableWorkLastMonthCreate;
