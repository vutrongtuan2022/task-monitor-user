...
import {PropsTableWorkAdditionalUpdate} from './interfaces';
import styles from './TableWorkAdditionalUpdate.module.scss';
...
function TableWorkAdditionalUpdate({onClose}: PropsTableWorkAdditionalUpdate) {
	const {listActivity, setListActivity, projectUuid} = useContext<IUpdateReportWork>(UpdateReportWork);
...
export default TableWorkAdditionalUpdate;
